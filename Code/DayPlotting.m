...
myTimes1 = minutes(1:length(temperatureDay1))*10;
myTimes2 = minutes(1:length(temperatureDay2))*10;
myTimes3 = minutes(1:length(temperatureDay3))*10;
